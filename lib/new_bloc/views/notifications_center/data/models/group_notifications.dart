class GroupNotifications {
  ...
  GroupNotifications({this.type, this.name, this.message, this.record_name, this.timestamp, this.record_id, this.note_id, this.module_id, this.notification_id, this.module_slug});

  GroupNotifications.fromJson(Map<String, dynamic> json) {
    type = json['type'];
    name = json['name'];
