...
import '../../../utilities/classes/hytech_url.dart';
import '../../../utilities/services/entity/calendar/accesible_meetings_entity.dart';
import '../../../utilities/services/entity/psegli_entity/pseg_form_entity.dart';
import '../../../utilities/services/entity/tasks/task_sort_fields.dart';
// import '../../new/presentation/task/list/task_view_model.dart';
// import '../../new/presentation/task/list/devices_screen_desktop.dart';
...
List<String>? allowedAttachmensExtensions = ['pdf', 'docx', 'xls', 'xlsx'];
...
final recordFormat = DateFormat("MMM d, yyyy");
...
var formatNotiList = new DateFormat.yMMMMd('en_US').add_Hm();
...
String lastSolarPanelSeleted = "Hanwha Q-cell 400w All Black";
...
const String baseUrl = "https://test.hytechgizmo.com/api/mobile";
const String hostUrl = "https://test.hytechgizmo.com";
//const String baseUrl = "http://gizmo.local/api/mobile";
//const String hostUrl = "https://gizmo.local";
