...
// import '../../screens/notifications/NotificationList.dart';
// import 'package:project/utilities/helpers/globaldata.dart' as globaldata;
//
// import '../services/navigatorKey_var_file.dart';
//
// ///  *********************************************
...
//     print("Notification: "+receivedAction.toMap().toString());
//     NotificationController.cancelNotifications();
//     if(receivedAction.channelKey == "alerts" && Platform.isIOS){
...
//     // else {
//     //
//     //   RouteKey.navigatorKey.currentState!.pushNamed('/notifications');
//     //  // Navigator.pushAndRemoveUntil(globaldata.mainContext, MaterialPageRoute(builder: (_) => NotificationList()), (route) => route.isFirst);
//     // }
//   }
//
//   ///  *********************************************
...
//     BuildContext context = globaldata.mainContext; //Notifi.navigatorKey.currentContext!;
//     await showDialog(
//         context: context,
...
//                     Expanded(
//                       child: Image.asset(
//                         'assets/images/animated/animated-bell.gif',
...
//   ///  *********************************************
//   ///
//   static Future<void> createNewNotification(String title, String message, String id, String imageLink, String type) async {
//     bool isAllowed = await AwesomeNotifications().isNotificationAllowed();
//     if (!isAllowed) isAllowed = await displayNotificationRationale();
//     if (!isAllowed) return;
//     NotificationLayout notiLayout = NotificationLayout.BigText;
//     if(imageLink.isNotEmpty){
//       notiLayout = NotificationLayout.BigPicture;
//     }
//
...
//             bigPicture: imageLink,//'asset://assets/images/drawer-header.png',//'https://storage.googleapis.com/cms-storage-bucket/d406c736e7c4c57f5f61.png',
//             largeIcon: 'asset://assets/images/hytech_sun.png',//'https://storage.googleapis.com/cms-storage-bucket/0dbfcc7a59cd1cf16282.png',
//             //'asset://assets/images/balloons-in-sky.jpg',
//             notificationLayout: notiLayout,
//             progress: 60,
...
//
//   @override
//   State<Notifi> createState() => NotifiState();
// }
//
...
//       navigatorKey: Notifi.navigatorKey,
...
//               heroTag: '1',
//               onPressed: () => NotificationController.createNewNotification("Title", "Message", "0", "", ""),
