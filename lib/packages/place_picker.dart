...
class PlacePickerState extends State<PlacePicker> {
              ...
              Expanded(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    // SelectPlaceActionCustom(getLocationName(), () {
                    //   if (Platform.isAndroid) {
                    //     _delayedPop();
                    //   } else {
                    //     print(this.locationResult);
                    //     Navigator.of(context).pop(this.locationResult);
                    //   }
  ...
  void reverseGeocodeLatLng(LatLng latLng) async {
    try {
      ...
      globaldata.mapCountry = placemarks.first.locality!;
      //globaldata.mapState = placemarks.first.country!;
      globaldata.mapState = placemarks.first.administrativeArea!;

      mapData!.country = placemarks.first.locality!;
      mapData!.street = placemarks.first.street!;
      mapData!.zipcode = placemarks.first.postalCode!;
      //mapData!.state = placemarks.first.country!;
      mapData!.state = placemarks.first.administrativeArea!;
      ...
      selected = placemarks.first.street! +
          ", " +
          placemarks.first.locality! +
          ", " +
          placemarks.first.administrativeArea! +
